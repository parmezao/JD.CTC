...
namespace JD.CTC.Presentation.Blazor.Shared
{
    public static class EditContextFluentValidationExtensions
    {
        ...
        private static IValidator GetValidatorForModel(object model)
        {
            ...
            var modelValidatorType = Assembly.GetAssembly(model.GetType()).GetTypes().FirstOrDefault(t => t.IsSubclassOf(abstractValidatorType));
